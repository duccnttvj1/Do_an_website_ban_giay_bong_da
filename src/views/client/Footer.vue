<template>
  <div class="row block-about" id="lienhe">
    <div class="about-left col-4">
      ...
      <div class="list-infor">
        ...
        nguyenmiinhduc203@gmail.com<br />
        <i class="fas fa-phone"></i>&ensp;Số điện thoại: 0399333760<br />
        <i class="fas fa-globe"></i>&ensp;Website: ducphatdat.com
      </div>
    </div>
  ...
  <div class="block-end">
    <div class="end-text">© 2024 Đức Phát Đạt</div>
  </div>
</template>
